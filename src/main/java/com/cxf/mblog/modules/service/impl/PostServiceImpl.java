...
import com.cxf.mblog.base.utils.*;
import com.cxf.mblog.modules.aspect.PostStatusFilter;
import com.cxf.mblog.modules.data.PostVO;
import com.cxf.mblog.modules.data.UserVO;
import com.cxf.mblog.modules.entity.*;
import com.cxf.mblog.modules.event.PostUpdateEvent;
import com.cxf.mblog.modules.repository.PostAttributeRepository;
import com.cxf.mblog.modules.repository.PostRepository;
import com.cxf.mblog.modules.repository.PostResourceRepository;
import com.cxf.mblog.modules.repository.ResourceRepository;
import com.cxf.mblog.modules.service.*;
...
//					builder.equal(root.get("featured").as(Integer.class), Consts.FEATURED_DEFAULT));
    ...
    public List<PostVO> findAll() {
        ...
        return this.toPosts(list);
    }

    @Override
    public List<Object[]> findByAuthorIdAndCreated(Long userId) {
        List<Object[]> authorIdAndCreated = postRepository.findAuthorIdAndCreated(userId);
        return authorIdAndCreated;
    }
     ...
     */
    @Override
    public List<PostVO> findByCreated(String year) {
        List<Post> byCreated = postRepository.findByCreated(year);
        return this.toPosts(byCreated);
    }
