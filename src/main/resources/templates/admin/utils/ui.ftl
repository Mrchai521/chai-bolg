...
<#macro layout>
    ...
    <head>
        ...
        <!-- Favicons -->
        <link rel="apple-touch-icon-precomposed" href="../../../static/dist/images/logo/logo.png"/>
        <link rel="shortcut icon" href="/static/dist/images/logo/logo.png"/>
    ...
    <div class="wrapper">
            ...
            <section class="sidebar">
                <div class="user-panel">
                    ...
                    <div class="pull-left info">
                        ...
                        <a href="${base}/logout" style="padding-left:5px;"><i class="fa fa-sign-out text-danger"></i> 注销</a>
                    </div>
                </div>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2020 <a href="#">CXF</a>.</strong> All rights reserved.
        </footer>
    </body>
    </html>
</#macro>
