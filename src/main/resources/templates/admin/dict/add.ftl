                ...
                <form id="qForm" class="form-horizontal form-label-left" method="post" action="add">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">新增字典分类</h3>
                        </div>
                        <div class="box-body">
                            <div class="form-group">
                                <label class="col-lg-2 control-label">字典名称</label>
                                <div class="col-lg-3">
                                    <input type="text" name="dictName" class="form-control"  required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-2 control-label">字典类型</label>
                                <div class="col-lg-3">
                                    <input type="text" name="dictType" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group">
